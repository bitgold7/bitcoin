...
parser = argparse.ArgumentParser(description='Script to get coins from a faucet.', epilog='You may need to start with double-dash (--) when providing bitgold-cli arguments.')
parser.add_argument('-c', '--cmd', dest='cmd', default='bitgold-cli', help='bitgold-cli command to use')
...
parser.add_argument('bitcoin_cli_args', nargs='*', help='Arguments to pass on to bitgold-cli (default: -signet)')
