...
* Update bitcoin.conf and commit changes if they exist, see [gen-bitgold-conf.sh](/contrib/devtools/README.md#gen-bitgold-confsh).
...
* Update the following variables in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) for mainnet, testnet, and signet:
  ...
  - `m_assumeutxo_data` array should be appended to with the values returned by calling `bitgold-cli -rpcclienttimeout=0 -named dumptxoutset utxo.dat rollback=<height or hash>`
