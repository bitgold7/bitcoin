...
For example:
    ...
    $ src/bitgold-cli -stdin walletpassphrase
    mysecretcode
    120
...
- #7550 `8b958ab` Input-from-stdin mode for bitgold-cli (laanwj)
...
- #8257 `ff03c50` Do not ask a UI question from bitgoldd (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for bitgoldd procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of bitgoldd startup (laanwj)
