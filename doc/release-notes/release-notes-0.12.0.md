...
This allows running bitgoldd without having to do any manual configuration.
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        # optional bypass bitgoldd rpc basic auth
...
Restarting bitgoldd will no longer clear out the list of banned peers; instead
...
- #6730 `cb4d6d0` build: Remove dependency of bitgold-cli on secp256k1 (Wladimir J. van der Laan)
...
- #6387 `11576a5` [bitgold-cli] improve error output (Jonas Schnelli)
