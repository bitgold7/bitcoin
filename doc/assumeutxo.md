...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitgoldd
instance.
...
```
$ bitgold-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitgold-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
