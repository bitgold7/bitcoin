...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-walletrebroadcastfeerate=<amt>", strprintf("Only rebroadcast wallet transactions with a feerate higher than this (in %s/kvB). Set to 0 to rebroadcast all unconfirmed transactions (default: estimate for next block)", CURRENCY_UNIT), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
