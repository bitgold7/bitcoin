...
{
    // Test that a previously fixed bug does not resurface.
    // With fListen=false in ~/.config/BitGold/BitGold-Qt.conf and all else left as default,
    // bitgold-qt should set both -listen and -listenonion to false and start successfully.
