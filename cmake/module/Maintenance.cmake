...
function(add_maintenance_targets)
  ...
  foreach(target IN ITEMS bitcoin bitgoldd bitcoin-qt bitgold-cli bitcoin-tx bitcoin-util bitcoin-wallet test_bitcoin bench_bitcoin)
    if(TARGET ${target})
...
function(add_windows_deploy_target)
  if(MINGW AND TARGET bitcoin AND TARGET bitcoin-qt AND TARGET bitgoldd AND TARGET bitgold-cli AND TARGET bitcoin-tx AND TARGET bitcoin-wallet AND TARGET bitcoin-util AND TARGET test_bitcoin)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bitgoldd> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bitgoldd>
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:bitgold-cli> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:bitgold-cli>
