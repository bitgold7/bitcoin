...
#
# Be aware that bitgoldd and bitcoin-qt differ in terms of localization: Qt
# opts in to POSIX localization by running setlocale(LC_ALL, "") on startup,
# whereas no such call is made in bitgoldd.
#
...
# C locale.
#
# In contrast, bitgoldd does not opt in to localization -- no call to
# setlocale(LC_ALL, "") is made and the environment variables LC_* are
# thus ignored.
#
# This results in situations where bitgoldd is guaranteed to be running
...
# call std::to_string(1.23) will return "1.230000" in bitgoldd but
