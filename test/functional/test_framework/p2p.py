...
"""Test objects for interacting with a bitgoldd node over the p2p protocol.

The P2PInterface objects interact with the bitgoldd nodes under test using the
...
MESSAGEMAP = {
    ...
    b"getstakemod": msg_getstakemod,
    b"stakemod": msg_stakemod,
    b"tx": msg_tx,
    b"verack": msg_verack,
