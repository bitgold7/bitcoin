...
DEFAULT_BLOCK_RESERVED_WEIGHT = 40000
...
# Objects that map to bitgoldd objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in bitgoldd
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in bitgoldd
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in bitgoldd indicates these should be deserialized as blocks
