...
with the bitgoldd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a bitgoldd.  `P2PInterface`
...
Test objects for interacting with a bitgoldd node over the p2p interface.
