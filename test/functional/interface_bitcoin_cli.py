...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bitgold-cli -h\" for help or \"bitgold-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitgold-cli getblockchaininfo`")
        ...
        # Prevent bitgold-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bitgold-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and bitgold-cli getwalletinfo return expected wallet info")
            ...
            # Test bitgold-cli -generate with -rpcwallet in multiwallet mode.
