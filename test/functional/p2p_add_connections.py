...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitgoldd node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # bitgoldd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitgoldd sends its own version prior to processing
